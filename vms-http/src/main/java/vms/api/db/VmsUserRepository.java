...
public class VmsUserRepository {
	...
	public int insertIntoUsers(String msisdn, String packId, Date nextRenewal) {

		String query = "insert into vms_users ( msisdn , status , pack_id , next_renewal_date , hlr_flag ) values (?,?,?,?,?)";
		log.info(query);
	...
	public int insertIntoUsers(String msisdn, String packId, Date nextRenewal, String lang, String channel , boolean renewal) {
		String query = "insert into vms_users ( msisdn , status , pack_id , next_renewal_date , hlr_flag , lang_code , channel , renewal_flag ) values (?,?,?,?,?,? , ?,?)";
		log.info(query);
